...
double AzZen::get_azimuth () const
{
  build ();
  return azimuth;
}
...
double AzZen::get_elevation () const
{
  build ();
  return elevation;
}
...
Matrix<3,3,double> AzZen::get_basis (const Vector<3,double>& from) const
{
  /*
