...
string Calibration::ScalarInverseTangent2::get_name () const
{
  return "ScalarInverseTangent2";
}

//! The function
double Calibration::ScalarInverseTangent2::function (double arg1,
						     double arg2) const
{
...
double Calibration::ScalarInverseTangent2::partial_arg1 (double arg1,
							 double arg2) const
{
  double z = arg1/arg2;
...
double Calibration::ScalarInverseTangent2::partial_arg2 (double arg1,
							 double arg2) const
{
  double z = arg1/arg2;
  double datan_dz = 1.0/(1.0 + z*z);
