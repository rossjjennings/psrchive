...
namespace Pulsar {
  ...
  class StokesFluctPhase : public FluctPlot {
  ...
  public:
    ...
    // Text interface to the StokesFluctPhase class
    class Interface : public TextInterface::To<StokesFluctPhase> {
    public:
      Interface (StokesFluctPhase* = 0);
    };
