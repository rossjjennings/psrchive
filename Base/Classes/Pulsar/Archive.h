...
namespace Pulsar {
  ...
  public:
    ...
    virtual void set_poln_calibrated (bool done = true) = 0;
		...
		virtual int get_file_number() const = 0;
    ...
    { return get_revision("$Revision: 1.143 $"); }
  ...
  protected:
    ...
    public:
      ...
      /*! This string is automatically generated by CVS.  Do not edit. */
      string get_revision () 
      { return Archive::get_revision ("$Revision: 1.143 $"); }
