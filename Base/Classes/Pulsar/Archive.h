...
namespace Pulsar {
  ...
  public:
     ...
     *
     *  All derived classes must provide access to the following attributes
     */
    //@{
...
<<<<<<< Archive.h
    ...
    virtual void get_PA (vector <Estimate<float> > &pas, float _startphase, float _stopphase);
...
=======
    virtual void defaraday (double rotation_measure = 0.0);
>>>>>>> 1.115
    ...
    { return get_revision("$Revision: 1.116 $"); }
  ...
  protected:
    ...
    */
    ...
    public:
      ...
      /*! This string is automatically generated by CVS.  Do not edit. */
      string get_revision () 
      { return Archive::get_revision ("$Revision: 1.116 $"); }
