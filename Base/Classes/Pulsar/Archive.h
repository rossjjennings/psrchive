...
namespace Pulsar {
  ...
  public:
    ...
    static string get_revision () { return get_revision("$Revision: 1.102 $"); }
    ...
    */
    ...
    public:
      ...
      string get_revision () 
      {
	return Archive::get_revision ("$Revision: 1.102 $");
      }
	...
	in Agent::init in order to ensure that the plugin object
	code is linked. */
